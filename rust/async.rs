...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "At least one malloc is performed, and possibly more."]
...
extern "C" {
    ...
    #[doc = "require suspending the task."]
    #[doc = ""]
    #[doc = "As io_uring is currently incapable of doing listening socket setup by itself,"]
    #[doc = "there is an explicit step for transferring the configured socket to io_uring"]
    #[doc = "as it is an expensive operation."]
    #[doc = ""]
    #[doc = "Newer Linux kernels have an io_uring capable of connecting socket setup and"]
    #[doc = "creation entirely within io_uring. If your kernel is so capable, that is used,"]
    #[doc = "else blocking syscalls are used and the socket transferred into io_uring."]
    #[doc = ""]
    #[doc = "When this call returns, all syscall-created resources are released and io_uring"]
    #[doc = "exclusively manages the socket."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "Returns immediately unless there are no free io_uring submission entries."]
    #[doc = "See `man connect` to explain parameters. The i/o priority used will be that"]
    #[doc = "from the task's current i/o priority setting."]
