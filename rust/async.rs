...
pub const monad_async_socket_status_monad_async_socket_status_not_created:
    monad_async_socket_status = 0;
pub const monad_async_socket_status_monad_async_socket_status_bound: monad_async_socket_status = 1;
pub const monad_async_socket_status_monad_async_socket_status_listening: monad_async_socket_status =
    2;
pub const monad_async_socket_status_monad_async_socket_status_connected: monad_async_socket_status =
    3;
pub const monad_async_socket_status_monad_async_socket_status_shutdown: monad_async_socket_status =
    4;
#[doc = "! \\brief The status of an open socket"]
pub type monad_async_socket_status = u8;
...
pub struct monad_async_socket_head {
    ...
    pub status: monad_async_socket_status,
    pub executor: monad_async_executor,
}
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "This is done by blocking syscall, as io_uring is currently incapable of doing"]
    #[doc = "listening socket setup by itself."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "This is done by blocking syscall followed by transferring the socket into"]
    #[doc = "io_uring, as io_uring is currently incapable of doing listening"]
    #[doc = "socket setup by itself."]
...
extern "C" {
    #[doc = " \\brief CANCELLATION POINT Suspend execution of the task until the connection"]
    #[doc = "either succeeds or fails."]
    #[doc = ""]
    #[doc = "Actual creation of the socket is delayed until this call as on newer Linux"]
    #[doc = "kernels it is possible to have io_uring perform socket setup and creation"]
    #[doc = "without needing to perform blocking syscalls (it cannot set up listening"]
    #[doc = "sockets, so we need to defer the setup until you either connect or bind)."]
