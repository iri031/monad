...
benchmark test has changed since to fix bugs which were incorrectly boosting
results
...
This is the AsyncIO wrapper of the new i/o executor at mid Nov 2024.

./benchmark_io_test_wrapped --storage /dev/mapper/raid0-rawblk1 --workload 0

Total ops/sec: 265534 mean latency: 387212 min: 87000 max: 1.241e+06


./benchmark_io_test_wrapped --storage /dev/mapper/raid0-rawblk1 --workload 0
--kernel-poll-thread 15

Total ops/sec: 322838 mean latency: 571476 min: 159000 max: 1.425e+06


./benchmark_io_test_wrapped --storage /dev/mapper/raid0-rawblk1 --workload 0
--kernel-poll-thread 15 --concurrent-io 128

Total ops/sec: 325416 mean latency: 376372 min: 161000 max: 1.051e+06

**** NOTE THAT max 128 concurrency with the new max concurrency implementation
is now max ops/sec! ****
...
Total ops/sec: 307397 mean latency: 199871 min: 60000 max: 1.272e+06




This is the new i/o executor direct at mid Nov 2024.

./benchmark_io_test_wrapped --storage /dev/mapper/raid0-rawblk1 --workload 0
--new-io-executor

Total ops/sec: 305335 mean latency: 555626 min: 305457 max: 1.91514e+06


./benchmark_io_test_wrapped --storage /dev/mapper/raid0-rawblk1 --workload 0
--kernel-poll-thread 15 --new-io-executor

Total ops/sec: 320627 mean latency: 563831 min: 204684 max: 1.84272e+06


./benchmark_io_test_wrapped --storage /dev/mapper/raid0-rawblk1 --workload 0
--kernel-poll-thread 15 --concurrent-io 128 --new-io-executor

Total ops/sec: 325309 mean latency: 389298 min: 163943 max: 1.19681e+06


./benchmark_io_test_wrapped --storage /dev/mapper/raid0-rawblk1 --workload 0
--kernel-poll-thread 15 --concurrent-io 64 --new-io-executor

Total ops/sec: 311786 mean latency: 203133 min: 60701 max: 908081
    ...
    try {
        ...
        if (!new_io_executor) {
            ...
            static auto const ticks_per_ns =
                (double)monad_ticks_per_second() / 1000000000.0;
            std::cout << "CPU ticks per second on this machine: "
                      << monad_ticks_per_second() << std::endl;
            {
                auto *desc =
                    (char *)to_result(
