use bn::{pairing, AffineG1, AffineG2, Fq, Fq2, Fr, Group, Gt, G1, G2};
use std::io::Read;
...
#[unsafe(no_mangle)]
pub extern "C" fn bn_mul_run(inp: *const u8, outp: *mut u8) -> u32 {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn bn_add_run(inp: *const u8, outp: *mut u8) -> u32 {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn bn_snarkv_run(inp: *const u8, len: usize) -> u32 {
