...
typedef int(monad_cma_alloc_fn)(
    struct monad_allocator *, size_t, size_t, monad_memblk_t *);

typedef void(monad_cma_dealloc_fn)(struct monad_allocator *, monad_memblk_t);

typedef bool(monad_cma_owns_fn)(struct monad_allocator *, monad_memblk_t);
...
static inline int monad_cma_alloc(
    monad_allocator_t *ma, size_t size, size_t align, monad_memblk_t *blk)
{
    if (ma == nullptr) {
...
static inline int monad_cma_calloc(
    monad_allocator_t *ma, size_t count, size_t size, size_t align,
    monad_memblk_t *blk)
{
...
static inline void monad_cma_dealloc(monad_allocator_t *ma, monad_memblk_t blk)
{
    if (ma == nullptr) {
        ma = monad_cma_get_default_allocator();
    }
...
static inline enum monad_cma_owns_result
