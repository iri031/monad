...
static inline void monad_fiber_channel_init(
    monad_fiber_channel_t *channel, monad_source_location_t srcloc);

static inline void monad_fiber_channel_push(
    monad_fiber_channel_t *channel, monad_fiber_vbuf_t *vbuf);

static inline monad_fiber_vbuf_t *
monad_fiber_channel_try_pop(monad_fiber_channel_t *channel);

static inline monad_fiber_vbuf_t *monad_fiber_channel_pop(
...
static inline void
monad_fiber_vbuf_init(monad_fiber_vbuf_t *vbuf, const struct iovec *iov);
...
monad_fiber_vbuf_t *monad_fiber_channel_pop(
    monad_fiber_channel_t *channel, monad_fiber_prio_t wakeup_prio)
{
