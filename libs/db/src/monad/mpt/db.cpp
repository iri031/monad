...
struct Db::RWOnDisk final : public Db::Impl
{
    ...
    {
        fiber::simple_promise<Node::UniquePtr> *promise;
    ...
    {
        fiber::simple_promise<size_t> *promise;
        NodeCursor root;
        StateMachine &sm;
    };
    ...
    {
        fiber::simple_promise<bool> *promise;
        Node &root;
    ...
    {
        fiber::simple_promise<void> *promise;
        uint64_t src;
        uint64_t dest;
    };
    ...
    {
        fiber::simple_promise<Node::UniquePtr> promise;
        //fprintf(stderr, "%p - %p S: %p sz: %lu\n", &promise, &promise + 1,
        //    promise.get_dbg(), sizeof promise);
        ...
        root_ = promise.get_future().get();
        //fprintf(stderr, "%p unblocked\n", promise.get_dbg());
    }
    ...
    virtual size_t prefetch_fiber_blocking() override
    {
        ...
        size_t const nodes_loaded = promise.get_future().get();
        return nodes_loaded;
    }
    ...
    virtual NodeCursor load_root_for_version(uint64_t const version) override
    {
        ...
        reader_root_ = promise.get_future().get();
