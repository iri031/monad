...
impl monad_async_task_claim_registered_io_buffer_flags {
    #[inline]
    pub fn for_write_ring(&self) -> ::std::os::raw::c_uint {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(0usize, 1u8) as u32) }
    }
    #[inline]
    pub fn set_for_write_ring(&mut self, val: ::std::os::raw::c_uint) {
        unsafe {
    ...
    pub fn new_bitfield_1(
        for_write_ring: ::std::os::raw::c_uint,
        fail_dont_suspend: ::std::os::raw::c_uint,
    ) -> __BindgenBitfieldUnit<[u8; 1usize]> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize]> = Default::default();
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let for_write_ring: u32 = unsafe { ::std::mem::transmute(for_write_ring) };
            for_write_ring as u64
        });
