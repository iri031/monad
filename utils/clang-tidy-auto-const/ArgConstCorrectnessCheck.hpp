//===--- ArgConstCorrectnessCheck.hpp - clang-tidy -------------------*- C++
//-*-===//
//
...
namespace clang::tidy::misc
{
    ...
    /// This check warns on arguments which could be declared const but are not.
    ///
    /// For the user-facing documentation see:
    /// TODO
    class ArgConstCorrectnessCheck : public ClangTidyCheck
    {
    public:
        ArgConstCorrectnessCheck(StringRef Name, ClangTidyContext *Context);
