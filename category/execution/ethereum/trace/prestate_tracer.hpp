...
namespace trace
{
    ...
    struct PrestateTracer
    {
        ...
        void encode(Map<Address, AccountState> const &, State &);
    ...
    nlohmann::json state_to_json(Map<Address, AccountState> const &, State &);
    void state_to_json(
        Map<Address, AccountState> const &, State &, nlohmann::json &);
