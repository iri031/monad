...
namespace trace
{
    ...
    void PrestateTracer::encode(
        Map<Address, AccountState> const &prestate, State &state)
    {
    ...
    void state_to_json(
        Map<Address, AccountState> const &trace, State &state, json &result)
    {
    ...
    json state_to_json(Map<Address, AccountState> const &trace, State &state)
    {
