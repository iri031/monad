...
namespace monad::vm::compiler::native
{
    ...
    using PreEmitterHook = std::function<void(Emitter &, size_t, size_t, Instruction const &)>;
    using PostEmitterHook = std::function<void(Emitter &, size_t, size_t, Instruction const &)>;
