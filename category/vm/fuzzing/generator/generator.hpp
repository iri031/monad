...
namespace monad::vm::fuzzing
{
    ...
    void from_json(json const &j, GeneratorFocus &gf)
    {
        gf.valid_jumpdest_prob =
            j.value("valid_jumpdest_prob", genericFocus.valid_jumpdest_prob);
        gf.valid_address_prob =
            j.value("valid_address_prob", genericFocus.valid_address_prob);
        ...
        gf.meaningful_constant_prob = j.value(
            "meaningful_constant_prob", genericFocus.meaningful_constant_prob);
        gf.small_constant_prob =
            j.value("small_constant_prob", genericFocus.small_constant_prob);
        ...
        gf.total_non_term_prob =
            j.value("total_non_term_prob", genericFocus.total_non_term_prob);
        gf.push_weight = j.value("push_weight", genericFocus.push_weight);
        gf.dup_weight = j.value("dup_weight", genericFocus.dup_weight);
        gf.call_weight = j.value("call_weight", genericFocus.call_weight);
        gf.returndatacopy_weight = j.value(
            "returndatacopy_weight", genericFocus.returndatacopy_weight);
        gf.create_weight = j.value("create_weight", genericFocus.create_weight);
        gf.uncommon_non_term_weight = j.value(
            "uncommon_non_term_weight", genericFocus.uncommon_non_term_weight);
        gf.random_byte_prob =
            j.value("random_byte_prob", genericFocus.random_byte_prob);

        gf.valid_jump_prob =
            j.value("valid_jump_prob", genericFocus.valid_jump_prob);

        gf.block_dist_p1 = j.value("block_dist_p1", genericFocus.block_dist_p1);
        gf.block_dist_p2 = j.value("block_dist_p2", genericFocus.block_dist_p2);
        gf.block_dist_p3 = j.value("block_dist_p3", genericFocus.block_dist_p3);
    }
