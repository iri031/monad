...
template <>
struct quick_status_code_from_enum<MONAD_MPT2_NAMESPACE::DbError>
    : quick_status_code_from_enum_defaults<MONAD_MPT2_NAMESPACE::DbError>
{
    ...
    static std::initializer_list<mapping> const &value_mappings()
    {
        static std::initializer_list<mapping> const v = {
            {MONAD_MPT2_NAMESPACE::DbError::key_not_found, "key not found", {}},
            {MONAD_MPT2_NAMESPACE::DbError::unknown, "unknown", {}},
            {MONAD_MPT2_NAMESPACE::DbError::version_no_longer_exist,
