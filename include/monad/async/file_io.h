...
//! \brief Suspend execution of the task until the file has been opened. See
//! `man open2` to explain parameters.
...
//! \brief Initiate a durable sync of an open file using `iostatus` as the
//! identifier. Returns immediately unless there are no free io_uring submission
//! entries. The i/o priority used will be that from the task's current i/o
//! priority setting. This is the right call to use to ensure written data is
//! durably placed onto non-volatile storage.
