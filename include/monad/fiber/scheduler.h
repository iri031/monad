...
void monad_fiber_scheduler_post    (monad_fiber_scheduler_t *, monad_fiber_task_t * task, size_t priority);
void monad_fiber_scheduler_dispatch(monad_fiber_scheduler_t *, monad_fiber_task_t * task, size_t priority);

monad_fiber_task_t * monad_fiber_scheduler_pop_higher_priority_task(monad_fiber_scheduler_t *, size_t priority);
