...
struct monad_fiber_task_node monad_fiber_task_queue_pop_front(struct monad_fiber_task_queue * );
void                         monad_fiber_task_queue_insert   (struct monad_fiber_task_queue *, monad_fiber_task_t * task, size_t priority);