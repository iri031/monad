...
void monad_fiber_pool_create(monad_fiber_channel_t *, size_t capacity, size_t element_size);
void monad_fiber_pool_destroy(monad_fiber_channel_t *);


bool monad_fiber_try_read(monad_fiber_channel_t *, void * target);
bool monad_fiber_try_write(monad_fiber_channel_t *, const void * source);

int monad_fiber_read(monad_fiber_channel_t *, void * target);
int monad_fiber_write(monad_fiber_channel_t *, const void * source);
